...
<div class="hero-wrap hero-bread"
	style="background-image: url('/static/images/ab.jpg');">
	<div class="container">
		<div
			class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				<p class="breadcrumbs">
					<span class="mr-2"><a href="/home/index">Home</a></span> <span>About</span>
				</p>
				<h1 style= "color:silver;" class="mb-0 bread">ABOUT</h1>
			</div>
		</div>
	</div>
</div>
<section style= "margin-top:2em;" class="ftco-section ftco-no-pb ftco-no-pt bg-light">
	<div class="container">
		<div class="row">
			<div
