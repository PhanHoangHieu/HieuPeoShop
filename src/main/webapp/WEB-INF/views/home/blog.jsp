				...
				<div class="row">
					<div class="col-md-12 d-flex ftco-animate">
						<div class="blog-entry align-self-stretch d-md-flex">
							<a href="/home/blogdetail" class="block-20"
							...
							<div class="text d-block pl-md-4">
								...
								<h3 class="heading">
									<a href="/home/blogdetail">Even the all-powerful Pointing
										has no control about the blind texts</a>
								</h3>
								<p>Far far away, behind the word mountains, far from the
									countries Vokalia and Consonantia, there live the blind texts.</p>
								<p>
									<a href="/home/blogdetail" class="btn btn-primary py-2 px-3">Read
										more</a>
								</p>
							</div>
						</div>
					...
					<div class="col-md-12 d-flex ftco-animate">
						<div class="blog-entry align-self-stretch d-md-flex">
							<a href="/home/blogdetail" class="block-20"
								style="background-image: url('/static/images/image_5.jpg');">
							</a>
							<div class="text d-block pl-md-4">
								<div class="meta mb-3">
									<div>
