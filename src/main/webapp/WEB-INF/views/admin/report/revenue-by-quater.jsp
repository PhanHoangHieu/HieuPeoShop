	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<p class="breadcrumbs">
					<span class="mr-2"><a href="/home/index">Home</a></span> <span>Inventory By Quater
						</span>
				</p>
				<h1 class="mb-0 bread">INVENTORY BY QUATER</h1>
			</div>
		</div>
	</div>
</div>
<div class="container">
	<jsp:include page="_revenue_quater_chart.jsp"/>
</div>
